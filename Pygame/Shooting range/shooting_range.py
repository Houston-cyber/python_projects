...
wood_bg = pygame.image.load('img/Wood_BG.png')
land_bg = pygame.image.load('img/Land_BG.png')
water_bg = pygame.image.load('img/Water_BG.png')
cloud1 = pygame.image.load('img/Cloud1.png')
cloud2 = pygame.image.load('img/Cloud2.png')
crosshair = pygame.image.load('img/crosshair.png')
duck_surface = pygame.image.load('img/duck.png')
